          ...
          if (idx !== undefined) {
            return (
              <sup key={i}>
                <a
                  href={`#source-${idx}`}
                  className="inline-flex items-center justify-center min-w-[1.1rem] h-4 rounded-full bg-blue-100 px-1 text-[10px] font-semibold text-blue-700 hover:bg-blue-200 transition-colors no-underline focus:outline-none focus:ring-1 focus:ring-blue-500"
